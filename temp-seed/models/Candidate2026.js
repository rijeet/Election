...
const CandidateListItemSchema = new mongoose_1.Schema({
...
const Candidate2026Schema = new mongoose_1.Schema({
...
exports.default = mongoose_1.default.models.Candidate2026 || mongoose_1.default.model('Candidate2026', Candidate2026Schema);
